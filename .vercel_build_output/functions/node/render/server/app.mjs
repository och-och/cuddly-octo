...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-7a622f45.js", "src/routes/index.svelte": "pages/index.svelte-e227be52.js", "src/routes/search/[page].svelte": "pages/search/[page].svelte-73ad7b53.js", "src/routes/post/[hash].svelte": "pages/post/[hash].svelte-5086d5f8.js"};
const manifest = {
  ...
  routes: [
    {
      ...
      css: ["assets/start-5666821b.css", "assets/pages/index.svelte-820c5bf2.css", "assets/Search-c8d77c08.css"],
      js: ["start-7a622f45.js", "chunks/vendor-fba389f8.js", "chunks/singletons-6b53f818.js", "pages/index.svelte-e227be52.js", "chunks/Search-1143f398.js"]
    },
    {
      type: "endpoint",
      pattern: /^\/search\/([^/]+?)\.json$/,
    ...
    },
    {
      ...
      css: ["assets/start-5666821b.css", "assets/pages/search/[page].svelte-47d7fbaa.css", "assets/Search-c8d77c08.css", "assets/Spinner-00a78802.css"],
      js: ["start-7a622f45.js", "chunks/vendor-fba389f8.js", "chunks/singletons-6b53f818.js", "pages/search/[page].svelte-73ad7b53.js", "chunks/Search-1143f398.js", "chunks/Spinner-e48fd751.js"]
    },
    {
      type: "endpoint",
      pattern: /^\/post\/([^/]+?)\.json$/,
    ...
    },
    {
      ...
      css: ["assets/start-5666821b.css", "assets/pages/post/[hash].svelte-d866dca7.css", "assets/Search-c8d77c08.css", "assets/Spinner-00a78802.css"],
      js: ["start-7a622f45.js", "chunks/vendor-fba389f8.js", "chunks/singletons-6b53f818.js", "pages/post/[hash].svelte-5086d5f8.js", "chunks/Search-1143f398.js", "chunks/Spinner-e48fd751.js"]
    }
  ]
};
...
var Search_svelte = ".flex.svelte-3iw62c{gap:0}.input.svelte-3iw62c{width:100%;border-bottom-left-radius:0;border-top-left-radius:0}.select.svelte-3iw62c{flex-grow:1;border-bottom-right-radius:0;border-top-right-radius:0}";
const css$6 = {
  code: ".flex.svelte-3iw62c{gap:0}.input.svelte-3iw62c{width:100%;border-bottom-left-radius:0;border-top-left-radius:0}.select.svelte-3iw62c{flex-grow:1;border-bottom-right-radius:0;border-top-right-radius:0}",
  map: '{"version":3,"file":"Search.svelte","sources":["Search.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { goto } from \\"$app/navigation\\";\\nimport { Rating } from \\"$lib/api\\";\\nexport let query = \\"\\";\\nexport let rating = Rating.Safe;\\nfunction search() {\\n    goto(`/search/1?q=${query}&f=${rating}`);\\n}\\n</script>\\n\\n<form class=\\"flex\\" on:submit|preventDefault={search}>\\n\\t<select class=\\"select\\" bind:value={rating}>\\n\\t\\t<option value={Rating.Safe}>S</option>\\n\\t\\t<option value={Rating.Questionable}>Q</option>\\n\\t\\t<option value={Rating.Explicit}>E</option>\\n\\t\\t<option value={Rating.Any}>A</option>\\n\\t</select>\\n\\t<input class=\\"input\\" type=\\"search\\" placeholder=\\"Search\\" bind:value={query}>\\n</form>\\n\\n<style>\\n.flex {\\n\\tgap: 0;\\n}\\n.input {\\n\\twidth: 100%;\\n\\tborder-bottom-left-radius: 0;\\n\\tborder-top-left-radius: 0;\\n}\\n.select {\\n\\tflex-grow: 1;\\n\\tborder-bottom-right-radius: 0;\\n\\tborder-top-right-radius: 0;\\n}\\n</style>"],"names":[],"mappings":"AAoBA,KAAK,cAAC,CAAC,AACN,GAAG,CAAE,CAAC,AACP,CAAC,AACD,MAAM,cAAC,CAAC,AACP,KAAK,CAAE,IAAI,CACX,yBAAyB,CAAE,CAAC,CAC5B,sBAAsB,CAAE,CAAC,AAC1B,CAAC,AACD,OAAO,cAAC,CAAC,AACR,SAAS,CAAE,CAAC,CACZ,0BAA0B,CAAE,CAAC,CAC7B,uBAAuB,CAAE,CAAC,AAC3B,CAAC"}'
};
const Search = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<form class="${"flex svelte-3iw62c"}"><select class="${"select svelte-3iw62c"}"${add_attribute("value", rating, 1)}><option${add_attribute("value", Rating.Safe, 0)}>S</option><option${add_attribute("value", Rating.Questionable, 0)}>Q</option><option${add_attribute("value", Rating.Explicit, 0)}>E</option><option${add_attribute("value", Rating.Any, 0)}>A</option></select>
	<input class="${"input svelte-3iw62c"}" type="${"search"}" placeholder="${"Search"}"${add_attribute("value", query, 1)}>
</form>`;
});
...
var Spinner_svelte = ".wrapper.svelte-1ld5awl{width:100%;height:100%;display:flex;justify-content:center;align-items:center}.spinner.svelte-1ld5awl{width:100px;height:100px;border:var(--gap) solid var(--color);border-top-color:transparent;border-radius:50%;animation:forwards infinite linear 1s svelte-1ld5awl-spin}@keyframes svelte-1ld5awl-spin{from{transform:rotate(0) }to{transform:rotate(360deg) }}";
const css$4 = {
  code: ".wrapper.svelte-1ld5awl{width:100%;height:100%;display:flex;justify-content:center;align-items:center}.spinner.svelte-1ld5awl{width:100px;height:100px;border:var(--gap) solid var(--color);border-top-color:transparent;border-radius:50%;animation:forwards infinite linear 1s svelte-1ld5awl-spin}@keyframes svelte-1ld5awl-spin{from{transform:rotate(0) }to{transform:rotate(360deg) }}",
  map: '{"version":3,"file":"Spinner.svelte","sources":["Spinner.svelte"],"sourcesContent":["<div class=\\"wrapper\\">\\n\\t<div class=\\"spinner\\"></div>\\n</div>\\n\\n<style>\\n.wrapper {\\n\\twidth: 100%;\\n\\theight: 100%;\\n\\n\\tdisplay: flex;\\n\\tjustify-content: center;\\n\\talign-items: center;\\n}\\n\\n.spinner {\\n\\twidth: 100px;\\n\\theight: 100px;\\n\\tborder: var(--gap) solid var(--color);\\n\\tborder-top-color: transparent;\\n\\tborder-radius: 50%;\\n\\tanimation: forwards infinite linear 1s spin;\\n}\\n\\n@keyframes spin {\\n\\tfrom { transform: rotate(0) }\\n\\tto   { transform: rotate(360deg) }\\n}\\n</style>"],"names":[],"mappings":"AAKA,QAAQ,eAAC,CAAC,AACT,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CAEZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,AACpB,CAAC,AAED,QAAQ,eAAC,CAAC,AACT,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CACb,MAAM,CAAE,IAAI,KAAK,CAAC,CAAC,KAAK,CAAC,IAAI,OAAO,CAAC,CACrC,gBAAgB,CAAE,WAAW,CAC7B,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,QAAQ,CAAC,QAAQ,CAAC,MAAM,CAAC,EAAE,CAAC,mBACxC,CAAC,AAED,WAAW,mBAAK,CAAC,AAChB,IAAI,AAAC,CAAC,AAAC,SAAS,CAAE,OAAO,CAAC,CAAC,CAAC,CAAC,AAC7B,EAAE,AAAG,CAAC,AAAC,SAAS,CAAE,OAAO,MAAM,CAAC,CAAC,CAAC,AACnC,CAAC"}'
};
const Spinner = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$4);
  return `<div class="${"wrapper svelte-1ld5awl"}"><div class="${"spinner svelte-1ld5awl"}"></div>
</div>`;
});
...
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${disabled ? `<div class="${["button", disabled ? "disabled" : ""].join(" ").trim()}"${add_attribute("href", link, 0)} ${disabled ? "disabled" : ""}>${slots.default ? slots.default({}) : ``}</div>` : `${link ? `<a class="${"button"}"${add_attribute("href", link, 0)}>${slots.default ? slots.default({}) : ``}</a>` : `<button class="${"button"}">${slots.default ? slots.default({}) : ``}</button>`}`}`;
});
...
var _hash__svelte = '.post.svelte-xwo5vu.svelte-xwo5vu{position:relative;display:grid;grid-template-columns:minmax(200px, 300px) 1fr;grid-template-rows:auto 1fr;grid-template-areas:"search picture"\n		"tags   picture"\n	;gap:var(--gap);padding:var(--gap)}.spinner.svelte-xwo5vu.svelte-xwo5vu{grid-area:picture;top:0;left:0;width:100%;max-height:100%;max-height:calc(100vh - var(--gap) * 2)}.picture.svelte-xwo5vu.svelte-xwo5vu{grid-area:picture;max-height:calc(100vh - var(--gap) * 2);margin-inline:auto}.picture.svelte-xwo5vu img.svelte-xwo5vu{max-width:100%;max-height:calc(100vh - var(--gap) * 2);border:1px solid var(--color);border-radius:var(--radius)}.tags.svelte-xwo5vu.svelte-xwo5vu{grid-area:tags;align-content:flex-start;gap:.2rem}.tag.svelte-xwo5vu.svelte-xwo5vu{flex-grow:1;padding:.4rem .6rem;text-align:center;font-size:.9rem;text-decoration:none;color:var(--font-on-color);background:var(--color);border-radius:var(--radius)}@media screen and (max-width: 700px){.post.svelte-xwo5vu.svelte-xwo5vu{grid-template-columns:1fr;grid-template-rows:repeat(3, auto);grid-template-areas:"picture"\n			"search"\n			"tags"\n		}}';
const css = {
  code: '.post.svelte-xwo5vu.svelte-xwo5vu{position:relative;display:grid;grid-template-columns:minmax(200px, 300px) 1fr;grid-template-rows:auto 1fr;grid-template-areas:"search picture"\n		"tags   picture"\n	;gap:var(--gap);padding:var(--gap)}.spinner.svelte-xwo5vu.svelte-xwo5vu{grid-area:picture;top:0;left:0;width:100%;max-height:100%;max-height:calc(100vh - var(--gap) * 2)}.picture.svelte-xwo5vu.svelte-xwo5vu{grid-area:picture;max-height:calc(100vh - var(--gap) * 2);margin-inline:auto}.picture.svelte-xwo5vu img.svelte-xwo5vu{max-width:100%;max-height:calc(100vh - var(--gap) * 2);border:1px solid var(--color);border-radius:var(--radius)}.tags.svelte-xwo5vu.svelte-xwo5vu{grid-area:tags;align-content:flex-start;gap:.2rem}.tag.svelte-xwo5vu.svelte-xwo5vu{flex-grow:1;padding:.4rem .6rem;text-align:center;font-size:.9rem;text-decoration:none;color:var(--font-on-color);background:var(--color);border-radius:var(--radius)}@media screen and (max-width: 700px){.post.svelte-xwo5vu.svelte-xwo5vu{grid-template-columns:1fr;grid-template-rows:repeat(3, auto);grid-template-areas:"picture"\n			"search"\n			"tags"\n		}}',
  map: '{"version":3,"file":"[hash].svelte","sources":["[hash].svelte"],"sourcesContent":["<script context=\\"module\\" lang=\\"ts\\">var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\\n    return new (P || (P = Promise))(function (resolve, reject) {\\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\\n        function rejected(value) { try { step(generator[\\"throw\\"](value)); } catch (e) { reject(e); } }\\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\\n    });\\n};\\n;\\n/**\\n * @type {import(\'@sveltejs/kit\').Load}\\n */\\nexport function load({ page }) {\\n    return __awaiter(this, void 0, void 0, function* () {\\n        return {\\n            props: {\\n                hash: page.params.hash,\\n                rating: page.query.get(\\"f\\")\\n            }\\n        };\\n    });\\n}\\n</script>\\n\\n<script lang=\\"ts\\">var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\\n    return new (P || (P = Promise))(function (resolve, reject) {\\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\\n        function rejected(value) { try { step(generator[\\"throw\\"](value)); } catch (e) { reject(e); } }\\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\\n    });\\n};\\nimport { onMount } from \\"svelte\\";\\nimport { getPost, Rating } from \\"$lib/api\\";\\nimport Search from \\"$lib/components/Search.svelte\\";\\nimport Spinner from \\"$lib/components/Spinner.svelte\\";\\nexport let hash;\\nexport let rating = Rating.Safe;\\nlet post = null;\\nonMount(() => __awaiter(void 0, void 0, void 0, function* () {\\n    post = yield getPost(hash);\\n}));\\nlet tags = [];\\n$: tags = post && post.tags\\n    .split(\\" \\")\\n    .map(tag => ({ original: tag, display: tag.replace(\\"_\\", \\" \\") }))\\n    || [];\\nlet loading = true;\\n</script>\\n\\n<div class=\\"post\\" class:loading>\\n\\t{#if loading}\\n\\t\\t<div class=\\"spinner\\">\\n\\t\\t\\t<Spinner/>\\n\\t\\t</div>\\n\\t{/if}\\n\\n\\t<div class=\\"picture\\">\\n\\t\\t{#if post}\\n\\t\\t\\t<img src={post.url} alt=\\"\\" on:load={()=>loading=false}>\\n\\t\\t{/if}\\n\\t</div>\\n\\n\\t<Search bind:rating/>\\n\\n\\t<div class=\\"tags | flex wrap\\">\\n\\t\\t{#each tags as tag}\\n\\t\\t\\t<a class=\\"tag\\" href={`/search/1?q=${tag.original}&f=${rating}`}>{tag.display}</a>\\n\\t\\t{/each}\\n\\t</div>\\n</div>\\n\\n<style>\\n.post {\\n\\tposition: relative;\\n\\tdisplay: grid;\\n\\tgrid-template-columns: minmax(200px, 300px) 1fr;\\n\\tgrid-template-rows: auto 1fr;\\n\\tgrid-template-areas:\\n\\t\\t\\"search picture\\"\\n\\t\\t\\"tags   picture\\"\\n\\t;\\n\\tgap: var(--gap);\\n\\tpadding: var(--gap);\\n}\\n\\n.spinner {\\n\\tgrid-area: picture;\\n\\ttop: 0;\\n\\tleft: 0;\\n\\twidth: 100%;\\n\\tmax-height: 100%;\\n\\tmax-height: calc(100vh - var(--gap) * 2);\\n}\\n\\n.picture {\\n\\tgrid-area: picture;\\n\\tmax-height: calc(100vh - var(--gap) * 2);\\n\\tmargin-inline: auto;\\n}\\n.picture img {\\n\\tmax-width: 100%;\\n\\tmax-height: calc(100vh - var(--gap) * 2);\\n\\tborder: 1px solid var(--color);\\n\\tborder-radius: var(--radius);\\n}\\n\\n.tags {\\n\\tgrid-area: tags;\\n\\talign-content: flex-start;\\n\\tgap: .2rem;\\n}\\n\\n.tag {\\n\\tflex-grow: 1;\\n\\tpadding: .4rem .6rem;\\n\\ttext-align: center;\\n\\n\\tfont-size: .9rem;\\n\\ttext-decoration: none;\\n\\tcolor: var(--font-on-color);\\n\\n\\tbackground: var(--color);\\n\\tborder-radius: var(--radius);\\n}\\n\\n@media screen and (max-width: 700px) {\\n\\t.post {\\n\\t\\tgrid-template-columns: 1fr;\\n\\t\\tgrid-template-rows: repeat(3, auto);\\n\\t\\tgrid-template-areas:\\n\\t\\t\\t\\"picture\\"\\n\\t\\t\\t\\"search\\"\\n\\t\\t\\t\\"tags\\"\\n\\t\\t;\\n\\t}\\n}\\n</style>"],"names":[],"mappings":"AA2EA,KAAK,4BAAC,CAAC,AACN,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,KAAK,CAAC,CAAC,KAAK,CAAC,CAAC,GAAG,CAC/C,kBAAkB,CAAE,IAAI,CAAC,GAAG,CAC5B,mBAAmB,CAClB,gBAAgB;EAChB,gBAAgB;CACjB,CACA,GAAG,CAAE,IAAI,KAAK,CAAC,CACf,OAAO,CAAE,IAAI,KAAK,CAAC,AACpB,CAAC,AAED,QAAQ,4BAAC,CAAC,AACT,SAAS,CAAE,OAAO,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,CAChB,UAAU,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,AACzC,CAAC,AAED,QAAQ,4BAAC,CAAC,AACT,SAAS,CAAE,OAAO,CAClB,UAAU,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACxC,aAAa,CAAE,IAAI,AACpB,CAAC,AACD,sBAAQ,CAAC,GAAG,cAAC,CAAC,AACb,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACxC,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,OAAO,CAAC,CAC9B,aAAa,CAAE,IAAI,QAAQ,CAAC,AAC7B,CAAC,AAED,KAAK,4BAAC,CAAC,AACN,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,UAAU,CACzB,GAAG,CAAE,KAAK,AACX,CAAC,AAED,IAAI,4BAAC,CAAC,AACL,SAAS,CAAE,CAAC,CACZ,OAAO,CAAE,KAAK,CAAC,KAAK,CACpB,UAAU,CAAE,MAAM,CAElB,SAAS,CAAE,KAAK,CAChB,eAAe,CAAE,IAAI,CACrB,KAAK,CAAE,IAAI,eAAe,CAAC,CAE3B,UAAU,CAAE,IAAI,OAAO,CAAC,CACxB,aAAa,CAAE,IAAI,QAAQ,CAAC,AAC7B,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACrC,KAAK,4BAAC,CAAC,AACN,qBAAqB,CAAE,GAAG,CAC1B,kBAAkB,CAAE,OAAO,CAAC,CAAC,CAAC,IAAI,CAAC,CACnC,mBAAmB,CAClB,SAAS;GACT,QAAQ;GACR,MAAM;EACP,AACD,CAAC,AACF,CAAC"}'
};
...
const U5Bhashu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="${["post svelte-xwo5vu", "loading"].join(" ").trim()}">${`<div class="${"spinner svelte-xwo5vu"}">${validate_component(Spinner, "Spinner").$$render($$result, {}, {}, {})}</div>`}

	<div class="${"picture svelte-xwo5vu"}">${post ? `<img${add_attribute("src", post.url, 0)} alt="${""}" class="${"svelte-xwo5vu"}">` : ``}</div>
	...
	<div class="${"tags | flex wrap svelte-xwo5vu"}">${each(tags, (tag) => `<a class="${"tag svelte-xwo5vu"}"${add_attribute("href", `/search/1?q=${tag.original}&f=${rating}`, 0)}>${escape(tag.display)}</a>`)}</div>
</div>`;
  } while (!$$settled);
  return $$rendered;
});
