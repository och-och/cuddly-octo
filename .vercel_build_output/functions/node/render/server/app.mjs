...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-bd4e6e65.js", "src/routes/index.svelte": "pages/index.svelte-4b0e3196.js", "src/routes/search/[page].svelte": "pages/search/[page].svelte-82fbfdb1.js", "src/routes/post/[hash].svelte": "pages/post/[hash].svelte-34031560.js"};
const manifest = {
  ...
  routes: [
    {
      ...
      js: ["start-bd4e6e65.js", "chunks/vendor-c4d175b0.js", "chunks/singletons-6b53f818.js", "pages/index.svelte-4b0e3196.js", "chunks/Search-b66ffe5c.js"]
    },
    {
      type: "endpoint",
      pattern: /^\/search\/([^/]+?)\.json$/,
    ...
    },
    {
      ...
      css: ["assets/start-37dca156.css", "assets/pages/search/[page].svelte-2918381f.css", "assets/api-7bb44a6d.css", "assets/Search-38625548.css"],
      js: ["start-bd4e6e65.js", "chunks/vendor-c4d175b0.js", "chunks/singletons-6b53f818.js", "pages/search/[page].svelte-82fbfdb1.js", "chunks/api-8633b337.js", "chunks/Search-b66ffe5c.js"]
    },
    {
      type: "endpoint",
      pattern: /^\/post\/([^/]+?)\.json$/,
    ...
    },
    {
      ...
      css: ["assets/start-37dca156.css", "assets/pages/post/[hash].svelte-ec7d5489.css", "assets/Search-38625548.css", "assets/api-7bb44a6d.css"],
      js: ["start-bd4e6e65.js", "chunks/vendor-c4d175b0.js", "chunks/singletons-6b53f818.js", "pages/post/[hash].svelte-34031560.js", "chunks/Search-b66ffe5c.js", "chunks/api-8633b337.js"]
    }
  ]
};
...
const Search = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<form class="${"flex"}"><input type="${"search"}" class="${"svelte-1yevg7"}"${add_attribute("value", query, 1)}>
	<button>search</button>
</form>`;
});
...
var Spinner_svelte = ".wrapper.svelte-1ng2nz0{position:absolute;top:0;left:0;width:100%;height:100%;display:flex;justify-content:center;align-items:center}.spinner.svelte-1ng2nz0{width:100px;height:100px;border:var(--gap) solid #0005;border-top-color:transparent;border-radius:50%;animation:forwards infinite linear 1s svelte-1ng2nz0-spin}@keyframes svelte-1ng2nz0-spin{from{transform:rotate(0) }to{transform:rotate(360deg) }}";
const css$3 = {
  code: ".wrapper.svelte-1ng2nz0{position:absolute;top:0;left:0;width:100%;height:100%;display:flex;justify-content:center;align-items:center}.spinner.svelte-1ng2nz0{width:100px;height:100px;border:var(--gap) solid #0005;border-top-color:transparent;border-radius:50%;animation:forwards infinite linear 1s svelte-1ng2nz0-spin}@keyframes svelte-1ng2nz0-spin{from{transform:rotate(0) }to{transform:rotate(360deg) }}",
  map: '{"version":3,"file":"Spinner.svelte","sources":["Spinner.svelte"],"sourcesContent":["<div class=\\"wrapper\\">\\n\\t<div class=\\"spinner\\"></div>\\n</div>\\n\\n<style>\\n.wrapper {\\n\\tposition: absolute;\\n\\ttop: 0;\\n\\tleft: 0;\\n\\twidth: 100%;\\n\\theight: 100%;\\n\\n\\tdisplay: flex;\\n\\tjustify-content: center;\\n\\talign-items: center;\\n}\\n\\n.spinner {\\n\\twidth: 100px;\\n\\theight: 100px;\\n\\tborder: var(--gap) solid #0005;\\n\\tborder-top-color: transparent;\\n\\tborder-radius: 50%;\\n\\tanimation: forwards infinite linear 1s spin;\\n}\\n\\n@keyframes spin {\\n\\tfrom { transform: rotate(0) }\\n\\tto   { transform: rotate(360deg) }\\n}\\n</style>"],"names":[],"mappings":"AAKA,QAAQ,eAAC,CAAC,AACT,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CAEZ,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,AACpB,CAAC,AAED,QAAQ,eAAC,CAAC,AACT,KAAK,CAAE,KAAK,CACZ,MAAM,CAAE,KAAK,CACb,MAAM,CAAE,IAAI,KAAK,CAAC,CAAC,KAAK,CAAC,KAAK,CAC9B,gBAAgB,CAAE,WAAW,CAC7B,aAAa,CAAE,GAAG,CAClB,SAAS,CAAE,QAAQ,CAAC,QAAQ,CAAC,MAAM,CAAC,EAAE,CAAC,mBACxC,CAAC,AAED,WAAW,mBAAK,CAAC,AAChB,IAAI,AAAC,CAAC,AAAC,SAAS,CAAE,OAAO,CAAC,CAAC,CAAC,CAAC,AAC7B,EAAE,AAAG,CAAC,AAAC,SAAS,CAAE,OAAO,MAAM,CAAC,CAAC,CAAC,AACnC,CAAC"}'
};
const Spinner = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$3);
  return `<div class="${"wrapper svelte-1ng2nz0"}"><div class="${"spinner svelte-1ng2nz0"}"></div>
</div>`;
});
...
const css$2 = {
  ...
  map: '{"version":3,"file":"PostPreview.svelte","sources":["PostPreview.svelte"],"sourcesContent":["<script lang=\\"ts\\">import Spinner from \\"./Spinner.svelte\\";\\nexport let post;\\nlet loading = true;\\n</script>\\n\\n<a href={`/post/${post.md5}`}>\\n\\t{#if loading}\\n\\t\\t<Spinner/>\\n\\t{/if}\\n\\t<img on:load={()=>loading=false} src={ post.preview } alt=\\"\\">\\n</a>\\n\\n<style>\\na {\\n\\tposition: relative;\\n}\\n\\nimg {\\n\\twidth: 100%;\\n\\theight: 100%;\\n\\tmin-height: 200px;\\n\\tobject-fit: contain;\\n}\\n</style>"],"names":[],"mappings":"AAaA,CAAC,eAAC,CAAC,AACF,QAAQ,CAAE,QAAQ,AACnB,CAAC,AAED,GAAG,eAAC,CAAC,AACJ,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,CACZ,UAAU,CAAE,KAAK,CACjB,UAAU,CAAE,OAAO,AACpB,CAAC"}'
};
const PostPreview = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<a${add_attribute("href", `/post/${post.md5}`, 0)} class="${"svelte-1khmcnq"}">${`${validate_component(Spinner, "Spinner").$$render($$result, {}, {}, {})}`}
	<img${add_attribute("src", post.preview, 0)} alt="${""}" class="${"svelte-1khmcnq"}">
</a>`;
});
async function searchPosts(page, tags) {
...
const U5Bpageu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `<main class="${"svelte-1s1s01z"}"><div class="${"search svelte-1s1s01z"}">${validate_component(Search, "Search").$$render($$result, {query}, {
      query: ($$value) => {
        query = $$value;
        $$settled = false;
      }
	...
	${function(__value) {
      if (is_promise(__value))
        return `
		<p class="${"info svelte-1s1s01z"}">Searching...</p>
	`;
      return function(posts2) {
        return `
		<p class="${"info svelte-1s1s01z"}">found ${escape(posts2.total)} posts</p>
		<div class="${"posts svelte-1s1s01z"}">${each(posts2.results, (post) => `${validate_component(PostPreview, "PostPreview").$$render($$result, {post}, {}, {})}`)}</div>
...
var Post_svelte = '.post.svelte-17aiebp.svelte-17aiebp{display:grid;grid-template-columns:minmax(100px, 200px) 1fr;grid-template-rows:auto 1fr;grid-template-areas:"search picture"\n		"tags   picture"\n	;gap:var(--gap);padding:var(--gap)}.picture.svelte-17aiebp.svelte-17aiebp{grid-area:picture;position:relative;min-width:100px;height:calc(100vh - var(--gap) * 2);margin-inline:auto}.picture.svelte-17aiebp img.svelte-17aiebp{max-width:100%;max-height:calc(100vh - var(--gap) * 2)}.tags.svelte-17aiebp.svelte-17aiebp{grid-area:tags;align-content:flex-start;gap:0}.tag.svelte-17aiebp.svelte-17aiebp{font-size:.9rem;text-decoration:none}@media screen and (max-width: 700px){.post.svelte-17aiebp.svelte-17aiebp{grid-template-columns:1fr;grid-template-rows:repeat(3, auto);grid-template-areas:"picture"\n			"search"\n			"tags"\n		}}';
const css = {
  code: '.post.svelte-17aiebp.svelte-17aiebp{display:grid;grid-template-columns:minmax(100px, 200px) 1fr;grid-template-rows:auto 1fr;grid-template-areas:"search picture"\n		"tags   picture"\n	;gap:var(--gap);padding:var(--gap)}.picture.svelte-17aiebp.svelte-17aiebp{grid-area:picture;position:relative;min-width:100px;height:calc(100vh - var(--gap) * 2);margin-inline:auto}.picture.svelte-17aiebp img.svelte-17aiebp{max-width:100%;max-height:calc(100vh - var(--gap) * 2)}.tags.svelte-17aiebp.svelte-17aiebp{grid-area:tags;align-content:flex-start;gap:0}.tag.svelte-17aiebp.svelte-17aiebp{font-size:.9rem;text-decoration:none}@media screen and (max-width: 700px){.post.svelte-17aiebp.svelte-17aiebp{grid-template-columns:1fr;grid-template-rows:repeat(3, auto);grid-template-areas:"picture"\n			"search"\n			"tags"\n		}}',
  map: '{"version":3,"file":"Post.svelte","sources":["Post.svelte"],"sourcesContent":["<script lang=\\"ts\\">import Search from \\"./Search.svelte\\";\\nimport Spinner from \\"./Spinner.svelte\\";\\nexport let post = null;\\nlet tags = [];\\n$: tags = post && post.tags\\n    .split(\\" \\")\\n    .map(tag => ({ original: tag, display: tag.replace(\\"_\\", \\" \\") }))\\n    || [];\\nlet loading = true;\\n</script>\\n\\n<div class=\\"post\\">\\n\\t<div class=\\"picture\\">\\n\\t\\t{#if loading}\\n\\t\\t\\t<Spinner/>\\n\\t\\t{/if}\\n\\t\\t{#if post}\\n\\t\\t\\t<img src={post.url} alt=\\"\\" on:load={()=>loading=false}>\\n\\t\\t{/if}\\n\\t</div>\\n\\n\\t<Search/>\\n\\n\\t<div class=\\"tags | flex v\\">\\n\\t\\t{#each tags as tag}\\n\\t\\t\\t<a class=\\"tag\\" href={`/search/1?q=${tag.original}`}>{tag.display}</a>\\n\\t\\t{/each}\\n\\t</div>\\n</div>\\n\\n<style>\\n.post {\\n\\tdisplay: grid;\\n\\tgrid-template-columns: minmax(100px, 200px) 1fr;\\n\\tgrid-template-rows: auto 1fr;\\n\\tgrid-template-areas:\\n\\t\\t\\"search picture\\"\\n\\t\\t\\"tags   picture\\"\\n\\t;\\n\\tgap: var(--gap);\\n\\tpadding: var(--gap);\\n}\\n\\n.picture {\\n\\tgrid-area: picture;\\n\\tposition: relative;\\n\\tmin-width: 100px;\\n\\theight: calc(100vh - var(--gap) * 2);\\n\\tmargin-inline: auto;\\n}\\n.picture img {\\n\\tmax-width: 100%;\\n\\tmax-height: calc(100vh - var(--gap) * 2);\\n}\\n\\n.tags {\\n\\tgrid-area: tags;\\n\\talign-content: flex-start;\\n\\tgap: 0;\\n}\\n\\n.tag {\\n\\tfont-size: .9rem;\\n\\ttext-decoration: none;\\n}\\n\\n@media screen and (max-width: 700px) {\\n\\t.post {\\n\\t\\tgrid-template-columns: 1fr;\\n\\t\\tgrid-template-rows: repeat(3, auto);\\n\\t\\tgrid-template-areas:\\n\\t\\t\\t\\"picture\\"\\n\\t\\t\\t\\"search\\"\\n\\t\\t\\t\\"tags\\"\\n\\t\\t;\\n\\t}\\n}\\n</style>"],"names":[],"mappings":"AA+BA,KAAK,8BAAC,CAAC,AACN,OAAO,CAAE,IAAI,CACb,qBAAqB,CAAE,OAAO,KAAK,CAAC,CAAC,KAAK,CAAC,CAAC,GAAG,CAC/C,kBAAkB,CAAE,IAAI,CAAC,GAAG,CAC5B,mBAAmB,CAClB,gBAAgB;EAChB,gBAAgB;CACjB,CACA,GAAG,CAAE,IAAI,KAAK,CAAC,CACf,OAAO,CAAE,IAAI,KAAK,CAAC,AACpB,CAAC,AAED,QAAQ,8BAAC,CAAC,AACT,SAAS,CAAE,OAAO,CAClB,QAAQ,CAAE,QAAQ,CAClB,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CACpC,aAAa,CAAE,IAAI,AACpB,CAAC,AACD,uBAAQ,CAAC,GAAG,eAAC,CAAC,AACb,SAAS,CAAE,IAAI,CACf,UAAU,CAAE,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,AACzC,CAAC,AAED,KAAK,8BAAC,CAAC,AACN,SAAS,CAAE,IAAI,CACf,aAAa,CAAE,UAAU,CACzB,GAAG,CAAE,CAAC,AACP,CAAC,AAED,IAAI,8BAAC,CAAC,AACL,SAAS,CAAE,KAAK,CAChB,eAAe,CAAE,IAAI,AACtB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACrC,KAAK,8BAAC,CAAC,AACN,qBAAqB,CAAE,GAAG,CAC1B,kBAAkB,CAAE,OAAO,CAAC,CAAC,CAAC,IAAI,CAAC,CACnC,mBAAmB,CAClB,SAAS;GACT,QAAQ;GACR,MAAM;EACP,AACD,CAAC,AACF,CAAC"}'
};
const Post = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"post svelte-17aiebp"}"><div class="${"picture svelte-17aiebp"}">${`${validate_component(Spinner, "Spinner").$$render($$result, {}, {}, {})}`}
		${post ? `<img${add_attribute("src", post.url, 0)} alt="${""}" class="${"svelte-17aiebp"}">` : ``}</div>

	${validate_component(Search, "Search").$$render($$result, {}, {}, {})}

	<div class="${"tags | flex v svelte-17aiebp"}">${each(tags, (tag) => `<a class="${"tag svelte-17aiebp"}"${add_attribute("href", `/search/1?q=${tag.original}`, 0)}>${escape(tag.display)}</a>`)}</div>
</div>`;
});
...
async function get$1({params, query}) {
  const {page} = params;
  const q = query.get("q");
  const res = await fetch$1(`https://cure.ninja/booru/api/json/${page}?q=${q}`);
  return {
    body: await res.json()
  };
}
